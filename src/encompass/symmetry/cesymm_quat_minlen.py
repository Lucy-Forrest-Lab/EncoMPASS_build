...
# Language: Python 3.5
# Date: 2 May 2017
# Updated: 2 May 2017, 9 Apr 2022
# Description: Run a structure with CE-Symm and options, eg. from temp/quat_symm_minlen_small_pdbs.log 
# Usage: python cesymm_quat_minlen.py 
...
def cesymm_quat_minlen(locations, options, inputf_options, pdb_suff, mem_req_limit = 20000, run_id="0000"):
    ...
    #cesymm_exe = options['ALL']['hpccesymm']
    #cesymm_exe_small = options['ALL']['hpccesymmsmall']
