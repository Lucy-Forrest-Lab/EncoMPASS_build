...
from encompass.symmetry.quatsymm_default import *
from encompass.symmetry.quatsymm_support import *
...
def quatsymm_complete(locations, options, inputf, pdb_suff, run_id="0000"):
	...
	#pymol = "/data/TMB-CSB/apps/CentOS7-LabLinux/pymol/2.5.0/bin/pymol -c"
	...
	if qsymm_results['symmetry'] == 'C1' or 'D' in qsymm_results['symmetry'] or qsymm_results['symmetry'] == 'na':
		...
		#summary['files_dir'] = locations['FSYS']['quatsymm'] + inputf + "/"
		...
		#super_pml_files, tm_score_super = repeats_superposition(outdir, oriented, pdb + pdb_suff, outdir,
		# 														pdb,
		# 														repeat_selection)
