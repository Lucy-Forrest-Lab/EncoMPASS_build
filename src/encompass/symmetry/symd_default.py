...
def symd_default(locations, options, inputf, pdb_suff, run_id="0000"):
    ...
    #symd_exe = "singularity exec /data/local/encompass/dev/Ubuntu1804-EncoMPASS.sif /EncoMPASS/symd1.61/src/symd1.61-linux"
    #symd_exe = "/data/TMB-CSB/Aleksandrova/software/symd1.61/src/symd1.61-linux"
    print(symd_exe)
...
if __name__ == "__main__":
    ...
    options, locations = initialize_repository(main_path=locations_path, instr_filename_path="EncoMPASS_options_relative_to__instructions_enc-tests-3.12-small.txt")
    #pdb_suff = '_enc'
