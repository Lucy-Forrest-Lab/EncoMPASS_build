...
# Usage: python select_minlen_violations_pdbs.py
...
def select_minlen_violations(locations, pdb_suff, tm_dic=False):
    ...
    print(f"Selection results saved in {locations['FSYSPATH']['cesymm_minlen_log']}minlen_violations_pdbs.pkl.")
    return select_minlen_dic

if __name__ == "__main__":
    #fs_dir = os.path.expanduser('~') + "/" + "EncoMPASS_1.1_2018_03_22/"
    #options, filters, locations = filesystem_info(fs_dir)
