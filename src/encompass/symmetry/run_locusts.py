...
def default_fn_options(options):
	...
	fn_opt['extra_outer_statements'] = 'export OMP_NUM_THREADS=1; ulimit -u 4096; export SINGULARITY_BINDPATH="$SINGULARITY_BINDPATH,/data/TMB-CSB/,/home/aleksandrovaaa/,/data/Encompass/,/usr/local/"'
...
if __name__ == "__main__":
	...
	locusts_tmp = '/data/local/encompass/toni_test_hpc/' # tmp dir for locusts on local machine
	#pdb_list = ['1a0s', '1a0t', '1a91', '1af6', '1afo', '1aig', '1aij', '1ap9', '1ar1', '1at9', '1aty', '1ay2',
	#			'1bcc', '1be3', '1bgy', '1bh3', '1bl8', '1bm1', '1brd', '1brr', '1brx', '1bt9', '1bxw', '1by3',
	#			'1by5', '1c0v', '1c17', '1c3w', '1c8r', '1c8s', '1c99', '1cwq', '1ds8', '1dv3', '1dv6', '1dx7',
	#			'1dxr', '1dze', '1dzo', '1e0p', '1e12', '1e14', '1e54', '1e6d', '1e7p', '1ehk', '1ek9', '1eys',
	#			'1ezv', '1f4z', '1f50', '1f6g', '1f6n', '1f88', '1fbb', '1fbk', '1fcp', '1fdm', '1fe1', '1fep']
