...
def cesymm_low_thr(locations, options, inputf, pdb_suff, mem_req_limit=20000, run_id="0000"):
    ...
    if num > mem_req_limit:
        #cesymm_path ="/data/TMB-CSB/Aleksandrova/software/cesymm-2.2.2/runCESymm.sh"
        cesymm_path = options['ALL']['sigcesymm']
        #cesymm_path = options['ALL']['hpccesymm']
    else:
        cesymm_path = options['ALL']['sigcesymmsmall']
        #cesymm_path = options['ALL']['hpccesymmsmall']
        #cesymm_path ="/data/TMB-CSB/Aleksandrova/software/cesymm-2.2.2/runCESymm.sh"
        #cesymm_path = "singularity exec /data/local/encompass/dev/Ubuntu1804-EncoMPASS.sif /EncoMPASS/cesymm-2.1.0/runCESymm_small.sh"
